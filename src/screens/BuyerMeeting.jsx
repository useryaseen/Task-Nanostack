...
//                 <th className="p-3 sticky right-0 bg-white border-l  z-[15] ">Action</th>
//               </tr>
//             </thead>
//             <tbody>
...
const statusOptions = [
  "Completed", "Upcoming", "Follow-up (3)", "Re-scheduled",
  "Overdue", "In Progress (1/3)", "Ongoing", "Draft", "Archived"
];
...
const BuyerMeeting = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="hidden sm:block border rounded-lg overflow-x-auto md:max-h-[500px]">
        <div className="min-w-[1200px]">
          <table className="w-full text-sm table-auto">
            <thead className="bg-gray-100 sticky top-0 z-[15]">
              <tr>
                <th className="p-3 w-10">
                  <input
                    type="checkbox"
